...
#  Tesseract DATA PREFIX Settings
os.environ["TESSDATA_PREFIX"] = '/home/cvmi_jeyoung/anaconda3/envs/torch2/share/tessdata'
...
# (예시)
# LANGSERVE_ENDPOINT = "https://delicate-weevil-exact.ngrok-free.app/llm/"
...
st.set_page_config(page_title="CVMILab-CUK Agent", page_icon="💬")
st.title("CVMILab-CUK Agent")


if "messages" not in st.session_state:
    st.session_state["messages"] = [
        ChatMessage(role="assistant", content="CVMILab-CUK의 AI Agent입니다. \n무엇을 도와드릴까요?")
    ]
